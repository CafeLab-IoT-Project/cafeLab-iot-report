...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <br>
      <strong>TB2:</strong>
      Participó junto con el equipo al planificar e implementar el tercer sprint del proyecto, para lo cual compartió ideas, propuestas y apoyó en la organización y división de partes. Además, colaboró al realizar las pruebas finales con el dispositivo IoT y se encargó de ponerlo en escenario.
      <br>
  ...
  <tr>
    ...
    <td>
      ...
      <br>
      <strong>TB2:</strong>
      Aportó al grupo al coordinar las reuniones y actividades a elaborar para cumplir con el último sprint del proyecto, así como animó a sus compañeros a realizar pruebas de la aplicación en conjunto e impulsó la comunicación constante dentro el equipo.
      <br>
      <strong>Yum Gonzales, Jorge Suin<br></strong> <strong>AV1:</strong>
...
La interfaz del Live Dashboard fue adaptada para ejecutarse en la Raspberry Pi del proyecto. En este escenario **headless**, el Edge corre como servicio `cafelab-edge.service` y el dashboard queda disponible en la red local mediante mDNS en `http://cafelab-edge.local:5000/dashboard` (o `http://<IP-de-la-Pi>:5000/dashboard`), accesible desde un navegador en otro dispositivo de la misma red WiFi. Esta configuración cumple el objetivo de supervisión local del lote definido en la US20 y en la tarea *Vista de monitoreo desde pantalla de Raspberry Pi* del Sprint Backlog 3.
